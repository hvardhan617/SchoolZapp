...
import { Content, Left, Right, Text, Card, CardItem } from "native-base";
    ...
    return (
      <Content padder>
        <Card style={{ borderRadius: 8, overflow: "hidden" }}>
          ...
          <CardItem>
            <View
              style={{ flexDirection: "column", flex: 0.5, marginLeft: 60 }}
            >
              <Text style={{ color: "grey", fontWeight: "700", fontSize: 12 }}>
                Attendance
              </Text>
            ...
            <View style={{ flexDirection: "column", flex: 0.5 }}>
              ...
              <ImageBackground
                ...
                style={{ height: 45, width: 45, marginTop: 6, marginBottom: 3 }}
              >
                <Text
                  style={{
                    marginTop: 22,
        ...
        <Card style={{ borderRadius: 8, overflow: "hidden" }}>
          <CardItem style={{ backgroundColor: "#71c4ad" }}>
            <Text style={{ color: "white", fontWeight: "900" }}>Grades</Text>
          </CardItem>
